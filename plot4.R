...
## Set the plotting parameters, four panels instead of one now
par(mfrow = c(2,2), mar = c(4,4,2,4), oma = c(1, 1, 1, 1))
...
## Plot line, for x combine the date and time object
with(mydf, plot((dates[truth] + times[truth]), Voltage[truth], type = 'l',
...
## Plot line, for x combine the date and time object
with(mydf, plot((dates[truth] + times[truth]), Global_reactive_power[truth], type = 'l',
